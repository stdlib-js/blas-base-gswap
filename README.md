...
```javascript
import gswap from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gswap@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-gswap/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/blas-base-gswap/actions/workflows/test.yml?query=branch:v0.2.2
